...
<div id="scraplist">
	...
	<div class="info">
		...
		<div class="category">
			...
			<select onchange="goHref('<?php echo $g['url_page']?>&category='+this.value);">
	...
	<td class="sbj">
		<a href="<?php echo $R['url']?>" target="_blank"><img src="<?php echo $g['img_core']?>/_public/ico_blank.gif" alt="" title="새창으로보기" /></a>
		<a href="<?php echo $R['url']?>"><?php echo $R['subject']?></a>
