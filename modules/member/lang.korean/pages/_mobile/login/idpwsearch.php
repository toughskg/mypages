...
<div id="pages_idpw">
	...
	<div class="agreebox">
		...
		<div class="submitbox">
			<input type="button" value=" 취 소 " class="btngray" onclick="history.back();" />
			<input type="submit" value=" 확 인 " class="btnblue" />
		</div>
		...
		<table>
			...
			<td>
				<span class="ques"><?php echo $d['member']['login_emailid']?'이메일':'아이디'?>인증</span> &gt; 질문인증 &gt; 재등록
			</td>
			</tr>
			<tr>
		...
		<div class="submitbox">
			<input type="button" value=" 취 소 " class="btngray" onclick="history.back();" />
			<input type="submit" value=" 인증요청 " class="btnblue" />
		</div>
		</div>
		...
		<table>
			...
			<td class="key">인증단계</td>
			<td>
				<?php echo $d['member']['login_emailid']?'이메일':'아이디'?>인증 &gt; <span class="ques">질문인증</span> &gt; 재등록
			</td>
			</tr>
			<tr>
		...
		<div class="submitbox">
			<input type="button" value=" 취 소 " class="btngray" onclick="history.back();" />
			<input type="submit" value=" 인증확인 " class="btnblue" />
		</div>
		</div>
		...
		<table>
			...
			<td class="key">인증단계</td>
			<td>
				<?php echo $d['member']['login_emailid']?'이메일':'아이디'?>인증 &gt; 질문인증 &gt; <span class="ques">재등록</span>
			</td>
			</tr>
			<tr>
